...
**2. Konfigurasi n8n**
Import: Impor file My workflow (2).json ke n8n Anda.
Credentials: Buat dan hubungkan 3 Credential utama (Google Sheets OAuth, Midtrans Basic Auth, WAHA Header Auth) pada node-node terkait di workflow.
**3. Edit Node CONFIG**
